...
let propertyName = 'types';

console.log(monster.propertyName); // error
console.log(monster[propertyName]); // good
...
console.log('the names of the pokémon whose only type is "poison" version 2');
for (let i = 0; i < pokémon.length; i++) {
  if (pokémon[i].types.length === 1) {
